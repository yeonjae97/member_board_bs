    ...
    <div class="card-body">
      <form method="post" autocomplete="off" class="form-horizontal form-material">
       ...
       <div class="d-flex justify-content-between">
		...
		<p>작성한 게시글</p> <span class="badge bg-warning">0</span>
		</div>
		<div class="d-flex justify-content-between">
		<p>작성한 댓글</p> <span class="badge bg-warning">0</span>
		</div>
        </div>
        <div class="mb-3 form-group">
          <label for="id" class="form-label d-block">ID</label>
          <input type="text" class="form-control border-0" id="id" placeholder="Enter id" name="id" value="${member.id}" readonly>
        </div>
        <hr>
        <h4 class="my-5"><i class="fas fa-list-ul"></i>부가정보</h4>
        <div class="mb-3 form-group">
          <label for="email" class="form-label">email</label>
          <input type="text" class="form-control border-0" id="email" placeholder="Enter email" name="email" value="${member.email}">
        </div>
        <div class="mb-3">
          ...
          <input type="text" class="form-control border-0 mt-3" id="addrDetail" placeholder="상세주소" name="addrDetail" readonly value="${member.addrDetail }">
        </div>
        <div class="mb-3">
